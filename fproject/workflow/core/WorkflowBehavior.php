...
{
	const DEFAULT_SOURCE_CLASS = 'fproject\workflow\factory\php\WorkflowPhpSource';
	...
	/**
	 * @var IWorkflowSource reference to the workflow source component used by this behavior
	 */
	private $_wfSource;
	/**
