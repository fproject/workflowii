...
{
	const DEFAULT_SOURCE_CLASS = 'fproject\workflow\source\php\WorkflowPhpSource';
	 ...
	 * @see \fproject\workflow\base\SimpleWorkflowBehavior::InitStatus()
	 */
	 ...
	 *
	 * @throws fproject\workflow\WorkflowException if the status attribute could not be converted into a Status object
	 */
	...
	/**
	 * @return \fproject\workflow\IStatusAccessor|null returns the Status accessor component used by this behavior
	...
	/**
	 * @return \fproject\workflow\Workflow | null the workflow the owner model is currently in, or null if the owner
	 ...
	 * @see \fproject\workflow\base\SimpleWorkflowBehavior::getDefaultWorkflowId()
	 */
